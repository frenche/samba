...
if have_heimdal_support:
    ...
    plantestsuite("samba4.blackbox.krb5.s4u(fl2008r2dc:local)", "fl2008r2dc:local", [os.path.join(bbdir, "test_s4u_mit.sh"), '$SERVER', '$USERNAME', '$PASSWORD', '$REALM', '$DOMAIN', '$TRUST_SERVER', '$TRUST_USERNAME', '$TRUST_PASSWORD', '$TRUST_REALM', '$TRUST_DOMAIN', '$PREFIX'])
